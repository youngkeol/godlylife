...
const MobileMemoFormBox = ({ modalClose }: { modalClose: () => void }) => {
  ...
  return (
    <div className={classes["memo-form-box"]}>
      <textarea
        className={`${classes["memo-form-content"]} ${classes["memo-form-content-editer"]}`}
      ...
      <div className={classes["memo-form-box-footer"]}>
        ...
        <button
          className={`${classes["memo-form-btn"]} ${classes["memo-form-cancel-btn"]}`}
          onClick={modalClose}
        >
          닫기
        </button>
...
export default MobileMemoFormBox;
